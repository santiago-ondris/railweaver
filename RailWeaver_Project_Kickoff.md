...
- **V0.8 — Train and running time ([RW-008](docs/specs/completed/RW-008-train-running-time.md), completada).** Material rodante V1 y cálculo determinista del tiempo de recorrido, con límites de velocidad por curva.
